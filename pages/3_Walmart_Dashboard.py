...
def render_overview(data, T, theme, lang):
    ...
    if api_key:
        ...
        if ai_summary:
            # CSS — окремо, без f-string (щоб {} не ламали парсинг)
            st.markdown("""
            <style>
                .ai-briefing-box {
                ...
                .ai-briefing-box p,
                .ai-briefing-box div,
                .ai-briefing-box span {
                    color: #f1f5f9 !important;
                }
                .ai-briefing-box b,
                .ai-briefing-box strong {
                    color: #ffffff !important;
                }
                .briefing-header {
                    display: flex;
            ...
            # HTML — окремо, з простим f-string (тільки змінні, без {})
            current_date = datetime.now().strftime('%B %d, %Y')
            briefing_html = (
                '<div class="ai-briefing-box">'
                '<div class="briefing-header">'
                '<div>'
                '<div class="briefing-meta">Strategic Briefing · Confidential</div>'
                '<div class="briefing-title">🎩 Partner-Level Analysis</div>'
                f'<div class="briefing-subtitle">UDC Mower Parts · Walmart Marketplace · {current_date}</div>'
                '</div>'
                '<div class="briefing-model">'
                f'Generated by<br><b>{ai_model}</b>'
                '</div>'
                '</div>'
                f'<div class="briefing-body">{ai_summary}</div>'
                '<div class="briefing-disclaimer">'
