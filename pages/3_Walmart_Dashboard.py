...
def render_overview(data, T, theme, lang):
    ...
    if api_key:
        ...
        if ai_summary:
            st.markdown(f"""
            <style>
                .ai-briefing-box, .ai-briefing-box * {{
                    color: #f1f5f9 !important;
                }}
                .ai-briefing-box b, .ai-briefing-box strong {{
                    color: #ffffff !important;
                }}
                .ai-briefing-box .briefing-meta {{
                    color: #cbd5e1 !important;
                }}
                .ai-briefing-box .briefing-disclaimer {{
                    color: #94a3b8 !important;
                }}
            </style>
            <div class="ai-briefing-box" style="background: linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #1e3a8a 100%);
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-start;
                    ...
                    <div>
                        <div class="briefing-meta" style="font-size:0.75rem; letter-spacing:2px; text-transform:uppercase;">
                            Strategic Briefing · Confidential
                        </div>
                        <div style="font-size:1.4rem; font-weight:600; margin-top:4px; color:#ffffff !important;">
                            🎩 Partner-Level Analysis
                        </div>
                        <div class="briefing-meta" style="font-size:0.85rem; margin-top:4px;">
                            UDC Mower Parts · Walmart Marketplace · {datetime.now().strftime('%B %d, %Y')}
                        </div>
                    </div>
                    <div class="briefing-disclaimer" style="font-size:0.7rem; text-align:right;">
                        Generated by<br><b style="color:#cbd5e1 !important;">{ai_model}</b>
                    </div>
                </div>
                <div style="font-size:1rem;">{ai_summary}</div>
                <div class="briefing-disclaimer" style="margin-top:20px; padding-top:14px; border-top: 1px solid rgba(255,255,255,0.15);
